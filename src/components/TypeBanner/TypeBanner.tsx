...
const TypeBanner = () => {
  return (
    <div className="type-banner mt-10 w-screen">
      ...
      <div className="type-banner-content w-full justify-center  grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 gap-5 mt-10 ">
        <div
        ...
        <div
          className="grid-item-2 bg-cover h-[300px] bg-no-repeat flex items-end rounded-md w-[300px] shadow-2xl md:w-[300px]"
        ...
        <div
          className="grid-item-3 bg-cover h-[300px] bg-no-repeat flex items-end rounded-md w-[300px] shadow-2xl md:w-[300px]"
        ...
        <div
          className="grid-item-4 bg-cover h-[300px] bg-no-repeat flex items-end rounded-md w-[300px] shadow-2xl md:w-[300px]"
