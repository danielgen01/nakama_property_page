...
const Formbox = () => {
  return (
    ...
    <div className="form-box bg-white h-2/4 w-2/3 flex items-center flex-col rounded-md gap-5">
    ...
    <button className="bg-main-light-blue text-white w-3/4 py-2 rounded-md font-bold">Submit</button>
    </div>
    </div>
  )
};
